...
/**
 * Definit les coordonnees de points dans l'arene et les outils (distance,
 * comparaison)
 */
public class PointComp extends Point implements Comparator<Point> {
	...
	private Integer distance(Point paux) {
		return (int) Math.sqrt(Math.pow(x - paux.x, 2)
				+ Math.pow(y - paux.y, 2));
	}
	 ...
	 * @param o2
	 *            le deuxieme point
	 * @return <0 si le premier point est plus proche, 0 si les points sont a la
	 *         meme distance et 1 si le deuxieme est plus proche
	 */
	@Override
