...
/**
 * Une potion: un element donnant des bonus aux caracteristiques de celui qui le
 * ramasse.
 */
public class Potion extends Element {
	...
	/**
	 * Constructeur d'une potion avec un nom et une quantite de force et de
	 * charisme (ces quantites sont celles ajoutees lorsqu'un Personnage ramasse
	 * cette potion).
	 * 
	 * @param nom
	 * @param force
