...
/**
 * Un personnage: un element possedant des caracteristiques et etant capable de
 * jouer une strategie.
 */
public class Personnage extends Element implements IPersonnage {
	...
	/**
	 * Reference des personnages de l'equipe de ce personnage. Vide si le leader
	 * n'est pas egal a -1.
	 */
	private ArrayList<Integer> equipe;

	/**
	 * Constructeur d'un personnage avec un nom et une quantite de force et de
	 * charisme. Au depart, le personnage n'a ni leader ni equipe.
	 * 
	 * @param nom
	 * @param force
	 * @param charisme
	...
	public void strategie(VueElement ve,
		...
		if (0 == voisins.size()) { // je n'ai pas de voisins, j'erre
			...
			if (elemPlusProche instanceof Personnage) {
				memeEquipe = (leader != -1 && leader == ((Personnage) elemPlusProche)
						.getLeader()) || // meme leader
						leader == refPlusProche || // cible est le leader de
													// this
