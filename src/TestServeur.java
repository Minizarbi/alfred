...
/**
 * Lancement de l'Arene. A lancer en premier. Arguments : numero de port, pile
 * et duree de vie (en millisecondes)
 */
public class TestServeur {
	...
	public static void main(String[] args) {
		...
		try {
			...
			int taillePile = 1; // par defaut les elements arrivent directement,
								// pas de pile
			...
			String ipNameArene = "localhost"; // le nom de la machine sur
												// laquelle tourne l'arene
			...
			while (duree < 0
					|| (System.currentTimeMillis() - tempsDepart) < duree) {
				System.out.println("[Arene sur "
