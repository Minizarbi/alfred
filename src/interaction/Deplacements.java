...
public class Deplacements implements IDeplacements {
	 ...
	 * donnee en parametre ref de soi-meme pour du sur-place, 0 pour errer et
	 * ref d'un voisin (s'il existe) On ne manipule que la VueElement
	 * 
	 * @param ref
	...
	public void seDirigerVers(int ref) {
		if (actionExecutee) {
			...
			} else {// sinon la cible devient le point sur lequel se trouve
			...
			// calcule la direction pour atteindre la ref (+1/-1 par rapport a
	...
	/**
	 * Deplace ce sujet d'une case en direction de la case specifiee. On ne
	 * manipule que la VueElement
	 * 
	 * @param pvers
	 *            case cible
	 */
