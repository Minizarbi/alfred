...
/**
 * Definit l'interface graphique. Allure des fenetres, connexion, recup des
 * elements sur l'arene et les dessines (a partir de VueElement)
 */
public class IHM extends JFrame {
	...
	/**
	 * Definit la fenetre de dialogue pour visualiser les arrivees,
	...
	/**
	 * Definit la fenetre de l'arene. Si le serveur de l'arene est connecte,
	 * recolte la VueElement des elements connectes et les dessine
	 */
	private class AreneJPanel extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			if ((state == State.INIT) || (cnxError)) {
				...
				// verifie si la connexion a ete realisee - isAlive
				// (Thread)==true si on est en cours de connexion
		...
		connection = new Thread() {
			public void run() {
				try {
					...
					serveur = Naming.lookup("rmi://" + ipArene + ":" + port
							+ "/Arene");
					// pour machine locale
