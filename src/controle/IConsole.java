...
public interface IConsole extends Remote {
	 ...
	 * 
	 * @param cause
	 *            la raison pour laquelle l'arret est demande
	...
	/**
	 * Modifie le leader (l'element courant et lead doivent etre des
	 * personnages).
	 * 
	 * @param lead
	 *            nouveau leader
	...
	/**
	 * Ajoute un personnage a l'equipe (l'element courant et lead doivent etre
	 * des personnages).
	 * 
	 * @param eq
	 *            nouvel equipier
	...
	/**
	 * Enleve un personnage de l'equipe (l'element courant et lead doivent etre
	 * des personnages).
	 * 
	 * @param eq
	 *            ancien equipier
	...
	/**
	 * Enleve tous personnages de l'equipe (l'element courant doit etre une
	 * personnages).
	 * 
	 * @throws RemoteException
	 */
	...
	/**
	 * Supprime le leader (sans modifier son equipe). Ne devrait pas etre
	 * utilise seul.
	 * 
	 * @throws RemoteException
	 */
