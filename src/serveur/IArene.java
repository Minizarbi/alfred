...
/**
 * Definit les methodes qui pourront s'appliquer a travers l'arene en RMI
 * (toutes celles qui levent RemoteException)
 */
public interface IArene extends Remote {
	 ...
	 * 
	 * @param ve
	 *            la vue de l'element a se connecter
	 * @throws RemoteException
	 */
	public void connect(VueElement ve, String ipConsole) throws RemoteException;

	/**
	 * Calcule la liste de toutes les representations d'elements presentes dans
	 * l'arene.
	 * 
	...
	/**
	 * Liste les voisins (representations d'element) d'une coordonnee dans
	 * l'arene sous la forme de couples (reference,coordonnees) dans une
	 * Hashtable
	 * 
	 * @throws RemoteException
	 */
